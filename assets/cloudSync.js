...
const CLOUDSYNC_VERSION = '2.2.2';
console.log(`[cloudSync] 加载版本: ${CLOUDSYNC_VERSION} (添加email必填字段)`);
  ...
  try {
    ...
    if (!existingUser && !checkError) {
      ...
      if (insertError) {
        ...
        console.error(`INSERT INTO users (id, email) VALUES ('${upsertData.owner_id}', '${userEmail}') ON CONFLICT (id) DO NOTHING;`);
